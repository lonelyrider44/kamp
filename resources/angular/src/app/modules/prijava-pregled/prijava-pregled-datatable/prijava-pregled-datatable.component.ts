...
@Component({
  selector: 'app-prijava-pregled-datatable',
  templateUrl: './prijava-pregled-datatable.component.html',
  styleUrls: ['./prijava-pregled-datatable.component.scss']
})
export class PrijavaPregledDatatableComponent implements OnInit {
