...
@Component({
  selector: 'app-pregled-index',
  templateUrl: './pregled-index.component.html',
  styleUrls: ['./pregled-index.component.scss']
})
export class PregledIndexComponent implements OnInit {
  kampovi: Kamp[] = [];
  smene: Smena[] = [];
  kamp_id: number = null;
