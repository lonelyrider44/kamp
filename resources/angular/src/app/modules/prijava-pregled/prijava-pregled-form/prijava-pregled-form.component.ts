...
@Component({
  selector: 'app-prijava-pregled-form',
  templateUrl: './prijava-pregled-form.component.html',
  styleUrls: ['./prijava-pregled-form.component.scss']
})
export class PrijavaPregledFormComponent implements OnInit {
