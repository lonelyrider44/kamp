...
@Component({
  selector: 'app-oprema-ucesnici-statistika-datatable',
  templateUrl: './oprema-ucesnici-statistika-datatable.component.html',
  styleUrls: ['./oprema-ucesnici-statistika-datatable.component.scss']
})
export class OpremaUcesniciStatistikaDatatableComponent implements OnInit {
