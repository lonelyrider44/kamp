...
@Component({
  selector: 'app-oprema-treneri-datatable',
  templateUrl: './oprema-treneri-datatable.component.html',
  styleUrls: ['./oprema-treneri-datatable.component.scss']
})
export class OpremaTreneriDatatableComponent implements OnInit {

  @ViewChild('dataTableOpremaTreneri') table;
  dataTable: any;
  ...
  ngAfterViewInit() {
    ...
    this.dataTable.DataTable({
      "ajax": (dataTablesParameters: any, callback) => {
        ...
        this.opremaService.datatable_treneri(dataTablesParameters).subscribe((data: any) => {
          callback({
      ...
      "columns": [
        { title: '#', data: 'id', name: 'treners.id', className: "dt-center" },
        { title: 'Trener', data: 'trener', name: 'treners.prezime', className: "dt-center" },
        ...
        { title: 'Veličina trenerke', data: 'velicina_trenerke', className: "dt-center" },
      ],
